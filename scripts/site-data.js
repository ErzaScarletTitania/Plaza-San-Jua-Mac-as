...
export const menuGroups = [
  {
    ...
    items: [
      ...
      { label: "Bebidas", href: "./categorias/gaseosas-aguas-y-jugos/" },
      { label: "Dulces y galletas", href: "./categorias/dulces-y-galletas/" },
    ],
  },
  {
    title: "Fresco para la semana",
    items: [
  ...
  {
    title: "Casa bien parada",
    items: [
      { label: "Limpieza", href: "./categorias/limpieza/" },
      { label: "Menaje", href: "./categorias/menaje-y-organizacion/" },
      { label: "Muebles", href: "./categorias/muebles/" },
      { label: "Dormitorio", href: "./categorias/dormitorio/" },
    ],
  },
];
